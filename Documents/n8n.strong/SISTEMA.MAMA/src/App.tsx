                          ...
                          <tr key={cliente.id} className="border-t border-slate-200 hover:bg-slate-50">
                            ...
                            <td className="px-5 py-4">
                              <button
                                ...
                                className="rounded-3xl bg-slate-100 px-4 py-2 text-sm text-textPrimary transition hover:bg-slate-200"
                              >
                                Pago rápido
                              </button>
                            </td>
          ...
          {page === 'nuevo-cliente' && (
            <section className="space-y-6">
              <div className="rounded-3xl bg-white p-6 shadow-panel sm:p-8">
                ...
                <p className="mt-1 text-sm text-textSecondary">Registra un cliente nuevo para que aparezca en la gestión.</p>
